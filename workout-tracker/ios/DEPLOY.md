...
- Imports signing certificates and provisioning profiles
...
| **Build not in TestFlight** | App Store Connect shows upload failed | Check workflow logs for "altool" errors; likely temporary Apple issue. Retry in 10 minutes. |
